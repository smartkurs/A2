...
var qstHead;
var groups;
var quizTitle="A2 test saison 1";
var printCpRg=1;
var filename = 'A2 test saison 1';
...
function initShortQuestion() {
 qstHead[0]="Welche Berufe erkennen Sie auf den Zeichnungen?  Taxifahrer. Sekretärin. In...";
 qstHead[1]="Was tun die Leute? Ordnen Sie den Berufen Tätigkeiten zu.  Auto fahren  Kin...";
 qstHead[2]="Über die Schulzeit   Hören Sie die Berichte und ergänzen Sie die Informatio...";
 qstHead[3]="Ergänzen Sie in den Sätzen die fehlenden Nomen  Abitur.  Fußball.  Grundsch...";
 qstHead[4]="Bilden Sie Fragen im Perfekt und antworten Sie. Beispiel • unterhalten - ih...";
 qstHead[5]="Ergänzen Sie die Verben in der richtigen Form.  bleiben stehen fahren. lieg...";
 qstHead[6]="Welches Präfix fehlt?  An- auf-aus-be-er- ein-mit-ver  Beispiel.Heute bin i...";
 qstHead[7]="Schreiben Sie Sätze im Perfekt. Beispiel  ein Haus in der Lorenzstraße miet...";
 qstHead[8]="Ergänzen Sie die Reflexivpronomen. ";
}
...
function Constructor() {
  ...
  typeOfQuest = new init_array(4,4,4,4,4,4,4,4,4);
