...
var qstHead;
var groups;
var quizTitle="A2 saison 7";
var printCpRg=1;
var filename = 'A2 saison 7';
...
function initShortQuestion() {
 qstHead[0]="Im Gartenverein  Lesen und hören Sie den folgenden Text          Was passie...";
 qstHead[1]="Wussten Sie, wie gesund Gemuse ist?  Lesen Sie den folgenden Text. Schlagen...";
 qstHead[2]="Im Restaurant    Hören Sie ein Gesprach in einem Restaurant und beantworten...";
 qstHead[3]="Lesen Sie den folgenden Text. Schlagen Sie unbekannte Worter im Worterbuch ...";
 qstHead[4]="Erganzen Sie die passenden Verben in der richtigen Form,   beurteilen. arbe...";
 qstHead[5]="Erganzen Sie dieVerben. Verwenden Sie   hängen, sitzen, setzen, liegen, leg...";
 qstHead[6]="Erganzen Sie wenn oder als.   Beispiel  Als ich meinen ersten Arbeitstag ha...";
 qstHead[7]="Was passt zusammen? Verbinden Sie. ";
 qstHead[8]="Bilden Sie Satze mit trotzdem im Perfekt.  Beispiel Peter wusste, dass die ...";
 qstHead[9]="Erganzen Sie die Präposition, eventuell die Kurzform und die Artikelendung....";
}
...
function Constructor() {
  ...
  typeOfQuest = new init_array(4,2,4,2,4,4,4,4,4,4);
