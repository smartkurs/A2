...
var qstHead;
var groups;
var quizTitle="A2 saison 2";
var printCpRg=1;
var filename = 'A2 saison 2';
...
function initShortQuestion() {
 qstHead[0]="Was kann man alles in der Freizeit machen?  malen und zeichnen.   Auto fahr...";
 qstHead[1]="Welcher Begriff passt zu welchem Verb? Ordnen Siezu.  Fahigkeit • Notwendig...";
 qstHead[2]="Telefonische Mitteilungen   a) Sie hören Nachrichten auf verschiedenen Anru...";
 qstHead[3]="Telefonische Mitteilungen   a) Sie hören Nachrichten auf verschiedenen Anru...";
 qstHead[4]="Telefonische Mitteilungen   a) Sie hören Nachrichten auf verschiedenen Anru...";
 qstHead[5]="Telefonische Mitteilungen   a) Sie hören Nachrichten auf verschiedenen Anru...";
 qstHead[6]="Erganzen Sie die passenden Verben.  ansehen . bestellen • gehen . mitnehmen...";
 qstHead[7]="Erganzen Sie nicht oder kein  ";
 qstHead[8]="Kinoprogramm Lesen Sie das Kinoprogramm des Berliner Film-Palastes.        ...";
 qstHead[9]="Erganzen Sie die Modalverben in der richtigen Form.  Beispiel Möchten Sie n...";
 qstHead[10]="Besuch beiTante Hilde Erganzen Sie die Verben im Prateritum.  Beispiel habe...";
 qstHead[11]="Erganzen Sie die fehlenden Verben.  verlor • lud ein • zog um .schrieb . gi...";
 qstHead[12]="Erganzen Sie niemand, niemanden, nichts oder nie.";
}
...
function Constructor() {
  ...
  typeOfQuest = new init_array(4,4,1,1,1,1,4,4,2,4,4,4,4);
