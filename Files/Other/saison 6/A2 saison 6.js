...
var qstHead;
var groups;
var quizTitle="A2 saison 6";
var printCpRg=1;
var filename = 'A2 saison 6';
...
function initShortQuestion() {
 qstHead[0]="Ordnen Sie zu.  laufen . kriechen .fliegen . schwimmen .krabbeln . galoppie...";
 qstHead[1]="Gefahrliche Tiere Lesen Sie den folgenden Text.      Was ist richtig, was i...";
 qstHead[2]="Schreiben Sie Sätze. Achten Sie auf die Reihenfolge und die Verbformen.   B...";
 qstHead[3]="Erganzen Sie Superlativ und Komparativ.  Beispiel Die giftigste Schlange de...";
 qstHead[4]="Lesen und horen Sie den Text          Was passt zusammen? Verbinden Sie die...";
 qstHead[5]="Welches Wort passt zur Definition?  Schlafstörung • Kopfschmerzen • Stress ...";
 qstHead[6]="Wie heißt das Gegenteil? Ordnen Sie zu.";
 qstHead[7]="Verwandtschaftsverhaltnisse  Meine Familie      Wer ist das?   Beispiel  Es...";
 qstHead[8]="Partnersuche im Internet  Lesen und horen Sie den folgenden Text.         W...";
 qstHead[9]="Wortschatz  Welches Verb passt? Ordnen Sie zu.  steigt. verkaufen • suchen ...";
 qstHead[10]="Erganzungen   Erganzen Sie die fehlenden Prapositionen.  im . auf. von . an...";
 qstHead[11]="Unnützes Wissen Erganzen Sie das passende Adjektiv.  teuerste . schnellste ...";
 qstHead[12]="Erganzen Sie die Relativpronomen.  Beispiel Ist das der Mann, von dem du mi...";
 qstHead[13]="Erganzen Sie die Präpositionen aus der Übersicht. Manchmal gibt es mehrere ...";
}
...
function Constructor() {
  ...
  typeOfQuest = new init_array(4,2,4,4,4,4,5,4,1,4,4,4,4,4);
