...
var qstHead;
var groups;
var quizTitle="A2 saison 5";
var printCpRg=1;
var filename = 'A2 saison 5';
...
function initShortQuestion() {
 qstHead[0]="Gesprach im Reiseburo   Hören Sie ein Gesprach im Reisebüro. Was ist richti...";
 qstHead[1]="Erganzen Sie im Dialog die fehlenden Verben. Lesen Sie den Text danach laut...";
 qstHead[2]="Fragen iiber Fragen Welches Fragewort passt?  wo . wie warm • wie groß • wa...";
 qstHead[3]="Reiseziel Wien Lesen Sie den folgenden Text.       Was ist richtig, was ist...";
 qstHead[4]="Lauras Urlaub  Laura hatte im Urlaub viel Pech. Erganzen Sie Lauras Reisebe...";
 qstHead[5]="Welche Satzverbindung passt?  ";
}
...
function Constructor() {
  ...
  typeOfQuest = new init_array(2,4,4,2,4,4);
