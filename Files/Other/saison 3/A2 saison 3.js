...
var qstHead;
var groups;
var quizTitle="A2 test saison 3";
var printCpRg=1;
var filename = 'A2 saison 3';
...
function initShortQuestion() {
 qstHead[0]="Wann und warum?  Ordnen Sie jeweils einen Grund und eine Bedingung zu.  ";
 qstHead[1]="Lesen und Hören Sie den folgenden Text.        1. Wie ist die Tendenz beim ...";
 qstHead[2]="2. Was kann man im Fernsehen kaufen?  ";
 qstHead[3]="3. Die meisten Kunden der Homeshopping Sender sind ";
 qstHead[4]="Im Internet  ";
 qstHead[5]="Rekonstruieren Sie den Text. Schreiben Sie Sätze in der angegebenen Zeitfor...";
 qstHead[6]="Geben Sie Wünsche im Konjunktiv II wieder.  Beispiel  Jutta ist nicht reich...";
 qstHead[7]="Ordnen Sie die richtigen Adjektive zu. vergleichbarer  unbekannter  kaufmän...";
 qstHead[8]="Wie heißt die richtige Präposition?  Beispiel über. aus. von Es gibt schon ...";
 qstHead[9]="Bilden Sie Nebensätze. Achten Sie auf die Wortfolge.   Beispiel  Der Pianis...";
}
...
function Constructor() {
  ...
  typeOfQuest = new init_array(4,1,1,1,1,4,4,4,4,4);
