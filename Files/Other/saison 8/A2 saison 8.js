...
var qstHead;
var groups;
var quizTitle="A2 saison 8";
var printCpRg=1;
var filename = 'A2 saison 8';
...
function initShortQuestion() {
 qstHead[0]="Der, die oder das Finden Sie die richtigen Artikel";
 qstHead[1]="Lesen Sie die Meldungen und ordnen Sie die Uberschriften zu.  Kuh klingelt ...";
 qstHead[2]="Meldungen Erganzen Sie die fehlenden Angaben.";
 qstHead[3]="Horen Sie die Nachrichten.  Was ist richtig, was ist falsch? Kreuzen Sie an...";
 qstHead[4]="Erganzen Sie die Verben im Partizip II.  bedrohen .fordern . gewinnen . fes...";
 qstHead[5]="Lesen und hören Sie den Text. Vergleichen Sie die Trends mit Ihren Vermütun...";
 qstHead[6]="Wozu werden diese Gerate gebraucht? Antworten Sie ";
 qstHead[7]="Was ist denn los? Sind bei dir die Handwerker? Antworten Sie wie im Beispie...";
 qstHead[8]="Bilden Sie Passivsatze im Prasens.  Beispiel.  Die Kinderzeitschrift Junior...";
 qstHead[9]="Verben mit Prapositionalobjekt Erganzen Sie die passenden Prapositionen.   ...";
 qstHead[10]="Geben Sie einen Zweck/ein Ziel an. Antworten Sie.  Beispiel Wozu fährst du ...";
 qstHead[11]="Verwenden Sie die richtige Praposition.   Beispiel.   auf-in -an 1 Auf der ...";
}
...
function Constructor() {
  ...
  typeOfQuest = new init_array(4,4,4,2,4,2,4,4,4,4,4,4);
